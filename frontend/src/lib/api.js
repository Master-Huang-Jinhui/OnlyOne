...
export const api = {
  ...
  deletePlatformReport: (id) => request(`/platform-reports/delete/${id}`),
  ...
  updateTranslation: (id, data) => request(`/translations/${id}/update`, { body: JSON.stringify(data) }),
  deleteTranslation: (id) => request(`/translations/delete/${id}`),
  ...
  findMemberByPhone: (phone) => request('/members/find-by-phone', { body: JSON.stringify({ phone }) }),
  createMember: (data) => request('/members', { body: JSON.stringify(data) }),
  updateMember: (id, data) => request(`/members/update/${id}`, { body: JSON.stringify(data) }),
  deleteMember: (id) => request(`/members/delete/${id}`),
  adjustMemberPoints: (data) => request('/members/points/adjust', { body: JSON.stringify(data) }),
  ...
  createCoupon: (data) => request('/coupons', { body: JSON.stringify(data) }),
  updateCoupon: (id, data) => request(`/coupons/update/${id}`, { body: JSON.stringify(data) }),
  deleteCoupon: (id) => request(`/coupons/delete/${id}`),
  claimCoupon: (data) => request('/coupons/claim', { body: JSON.stringify(data) }),
  getMemberCoupons: (data) => request('/coupons/member/list', { body: JSON.stringify(data) }),
  ...
  getHourlySales: (params) => request('/stats/hourly/sales', { body: JSON.stringify(params || {}) }),
  getDiningTypeSales: (params) => request('/stats/dining-type/sales', { body: JSON.stringify(params || {}) }),
  getTopProductsReport: (params) => request('/stats/top/products', { body: JSON.stringify(params || {}) }),
  getProfitAnalysis: (params) => request('/stats/profit/analysis', { body: JSON.stringify(params || {}) })
}
