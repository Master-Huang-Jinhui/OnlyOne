                ...
                <table className="w-full text-sm">
                  ...
                  <tbody>{importResults.map((r, i) => (
                    <tr key={i} className="border-t hover:bg-gray-50">
                      ...
                      <td className="px-3 py-2 text-right">{r.purchaseQty}</td>
                      <td className="px-3 py-2 text-center">{r.unit}</td>
                      <td className="px-3 py-2 text-right">{r.portionPerUnit}</td>
                      <td className="px-3 py-2 text-right">${r.sellPrice?.toFixed(2)}</td>
