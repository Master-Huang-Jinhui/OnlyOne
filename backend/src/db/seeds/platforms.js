...
module.exports = function(db) {
  const defaultPlatforms = [
    ...
    { name: 'HungerPanda', logo: 'https://www.hungrypanda.co/images/favicon.png', url: 'https://merchant-usa.hungrypanda.co/login', account: '', password: '', phone: '', note: '熊猫外卖', sort_order: 5 },
    { name: '小灰云', logo: 'https://www.led-cloud.com/favicon.ico', url: 'https://www.led-cloud.com/#/Account/Login', account: 'OnlyOneBBQandTea', password: '121227jJ162', phone: '', note: '', sort_order: 6 },
  ...
  // 强制更新url和logo（每次启动都同步最新商家后台地址和logo）
